...
const Footer: NextPage = () => {
  return (
    <div className="flex-col justify-center justify-between items-center w-screen h-fit bg-PDIBLUE text-white fixed inset-x-0 bottom-0 block md:flex m-0 p-0">
